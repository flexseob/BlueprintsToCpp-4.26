...
AQuestMarker::AQuestMarker()
{
	...
	ParticleSystem1 = CreateDefaultSubobject<UParticleSystemComponent>(TEXT("ParticleSystem"));

	SetRootComponent(Root);
	ParticleSystem1->SetupAttachment(Root);
}
...
void AQuestMarker::RefreshVisibility()
{
	...
	ParticleSystem1->SetVisibility(Visibility);
}
